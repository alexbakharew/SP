...
int tCG::p33(){ //  HCOND -> ( cond CLAUS
  S1->obj ="("+S3->obj;
	return 0;
}
int tCG::p34(){ //  CLAUS -> HCLAUS E1 )
  S1->obj += "(" + S2->obj + ") :\n";
	return 0;
}
...
int tCG::p36(){ // HCLAUS -> HCLAUS DISPSET
...
int tCG::p39(){ //  HELSE -> HELSE DISPSET
  if (S1->count > 0)
		S1->obj += ",\n";
	S1->obj += S2->obj;
  ++S1->count;
...
int tCG::p60(){ //    SIF -> SIFTRUE STR )
  S1->obj += ":"+S2->obj;
	return 0;
}
int tCG::p61(){ //SIFTRUE -> HIF STR
  S1->obj += S2->obj;
	return 0;
}
int tCG::p62(){ //    SET -> HSET E1 )
  //S1->obj += " = " + S2->obj ;
  S1->obj += S2->obj + ";\n";
	return 0;
}
int tCG::p63(){ //   HSET -> ( set! $id
  S1->obj += decor(S3->name) + " = ";
	return 0;
}
int tCG::p64(){ //DISPSET -> ( display E1 )
  S1->obj = "display("+S3->obj+")";
	return 0;
}
int tCG::p65(){ //DISPSET -> ( display BOOL )
  S1->obj = "display("+S3->obj+")";
	return 0;
}

int tCG::p66(){ //DISPSET -> ( display STR )
  S1->obj = "display("+S3->obj+")";
	return 0;
}
//?
int tCG::p67(){ //DISPSET -> ( newline )
  S1->obj = "newline()";
	return 0;
}

int tCG::p68(){ //DISPSET -> SET
  //??????????????????????????????????
	return 0;
}
...
int tCG::p77(){ //   PROC -> HPROC $dec )
  S1->obj += "return " + S2->name + ";\n}\n";
	return 0;
}
int tCG::p78(){ //   PROC -> HPROC E1 )
...
int tCG::p80(){ //  HPROC -> HPROC DISPSET
  S1->obj += S2->obj + ";\n";
	return 0;
}
